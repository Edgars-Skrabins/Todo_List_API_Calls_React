    ...
    return (
        <div className="edit-dialog-container">
            <form className="header__form">
                <label htmlFor="js-edit-taskname"> Task Name </label>
                <input maxLength={20}
                       type="text"
                ...
                <div className="row-buttons">
                    <button className="button header__btn" onClick={onEditCancel}> Cancel</button>
                    <button className="button header__btn" onClick={(e) => onEditConfirm(e,id)}> Confirm</button>
                </div>
            </form>
        </div>
    )
